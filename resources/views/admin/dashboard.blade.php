    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="heading-title">{{trans('admin/dashboard.dashboard')}}</span>
            </div>
           <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-3">
                        <a href="{{Url()}}/public/fileman?langCode={{Lang::locale()}}" target="_blank" class="thumbnail dashboard-item">
